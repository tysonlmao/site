export interface PlayerData {
  ...
  export function formatPlayerData(playerData: PlayerData): PlayerData {
    return {
      player: {
        karma: playerData.karma.toLocaleString(),
        networkExp: number;
        achievementPoints: playerData.karma.toLocaleString(),
        firstLogin: number;
        stats: {
          Bedwars: {
            wins_bedwars: number;
